...
public class OfferingListAdapter extends ArrayAdapter<Offering> {
    ...
    {
        final Offering selectedOffering = mOfferingsList.get(pos); //position is zero-based
        // DONE (1): Get a reference to the selectedCourse and the selectedInstructor
        //both are the linked in offering
        ...
        //overloaded int looks for id not the value of the string
